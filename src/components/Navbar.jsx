  ...
  return (
    <header className='bg-black text-white fixed top-0 left-0 right-0'>
        <nav className='px-4 py-4 max-w-7xl mx-auto flex justify-between items-center'>
            <a href="/" className='text-xl font-bold text-white'>BLOG<span className='text-red-300'>ME</span></a>
            ...
            <div className='text-white lg:flex gap-4 items-center hidden'>
                ...
                <button className='bg-red-300 px-6 py-2 font-medium rounded hover:bg-white 
                hover:text-red-500 transition-all duration-200 ease-in'>Log in</button>
            </div>
